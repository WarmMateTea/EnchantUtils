...
public class Anvil {
    ...
    private Item BinaryJoin(Item TargetItem, ArrayList<Item> EnchantmentBooks, Integer XPCW, AnvilResponse AR) {
    ...
    private Item Combine(Item Target, Item Sacrifice, Integer _XPCW) {
